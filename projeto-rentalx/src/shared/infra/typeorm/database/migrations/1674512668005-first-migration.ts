...
export class firstMigration1674512668005 implements MigrationInterface {
    name = 'firstMigration1674512668005'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "cars" ADD CONSTRAINT "FK_a2b557e0841c5764de159f8dcc5" FOREIGN KEY (" category") REFERENCES "categories"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
    }

    public async down(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE "cars" DROP CONSTRAINT "FK_a2b557e0841c5764de159f8dcc5"`);
